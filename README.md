...
Senior Backend Engineer specialized in building high-throughput, scalable enterprise applications using **Java** and the **Spring Ecosystem**. 

### 🛠️ Tech Stack & Expertise
- **Languages:** Java (8/17), SQL (PostgreSQL, MySQL, Oracle)
- **Frameworks:** Spring Boot, Spring Data JPA, Hibernate, Microservices, Spring AI
- **Distributed Infrastructure:** Apache Kafka, RESTful APIs, Distributed Caching (Redis)
- **Cloud & DevOps:** Google Cloud Platform (GCP), AWS, Docker, Kubernetes, Jenkins
